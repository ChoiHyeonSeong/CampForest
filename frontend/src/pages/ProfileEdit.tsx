  ...
  return (
    <div className='md:mt-[1rem] lg:mt-[3rem] mx-auto p-6 md:w-[40rem] lg:p-0'>
      ...
      <Link to='/user/password'>
        <div className='text-[#398EFF] font-md font-medium cursor-pointer'>비밀번호 변경하기</div>
      </Link>
      

      {/* 완료 버튼 */}
      <div className='text-center'>
        <button className='md:mt-[3rem] border-2 border-black font-bold w-[20rem] md:rounded-none rounded-md md:w-[11rem] h-[2.5rem] hover:bg-black hover:text-white transition-all duration-300'>
            완료
        </button>
      </div>
    </div>
