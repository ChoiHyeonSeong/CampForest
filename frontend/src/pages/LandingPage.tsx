        ...
        <div className="flex flex-col flex-all-center w-screen h-screen text-white snap-start">
          ...
          <div className="flex flex-col flex-all-center w-full h-[80%] lg:h-[65%] bg-white bg-opacity-60 lg:px-[2rem] xl:px-[3.5rem] lg:pb-[8rem]">
            ...
            <div className="h-[70%] justify-between flex flex-col lg:flex-row flex-all-center w-full mb-[2rem] max-lg:py-[0.75rem] lg:h-[70%] text-black">
              ...
              >
                <p className="font-bold text-2xl md:text-3xl mb-[1rem] lg:mb-[1.5rem] text-[#ff7f50]">
                  01
                </p>
                <div>
                  <p className="font-bold text-base sm:text-[1.2rem] md:text-[1.5rem] xl:text-[1.7rem] mb-[0.5rem] lg:mb-[1rem]">
                    캠핑장비 대여·판매
                  </p>
                  <p className="font-semibold text-sm sm:text-[1rem] lg:text-[1.05rem] xl:text-lg">
                    원하는 지역을 설정 후, <br /> 장비를 대여 및 판매해보세요.
                  </p>
                </div>
              </div>
              <div
                ...
                data-aos-duration="2000"
              >
                <p className="font-bold text-2xl lg:text-3xl mb-[1rem] lg:mb-[1.5rem] text-[#ff7f50]">
                  02
                </p>
                <div>
                  <p className="font-bold text-base sm:text-[1.2rem] md:text-[1.5rem] xl:text-[1.7rem] mb-[0.5rem] lg:mb-[1rem]">
            ...
            <div className="flex justify-center w-full mt-[2.5rem] lg:mt-[3rem] font-medium ">
              ...
              >
                <span className="relative z-10 group-hover:text-[#ff7f50] transition-colors duration-300">
                  시작하기
                </span>
