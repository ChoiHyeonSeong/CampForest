...
const ChatTradeModal = (props: Props) => {
  const [price, setPrice] = useState<number>(props.product.productPrice);
  const [deposit, setDeposit] = useState<number | null>(props.product.deposit);
  const [location, setLocation] = useState<string>(props.product.location);
            ...
            <div className='relative w-3/4 px-[1rem]'>
              <div>
                ...
                <div 
                  ...
                  '
                >
                  {props.product.productType === 'RENT' ? '대여' : '판매'}
                </div>
              </div>
              <div 
                className='
              ...
              >
                <div className='flex items-center'>
                  ...
                  <span className='font-semibold'>
                    {props.product.productType === 'RENT' ? `${props.product.productPrice}원` : `${props.product.productPrice}원/일`}
                  </span>
                </div>
                {props.product.productType ==='RENT' ? (
                  <div className='flex items-center'>
                    <span 
                      className='
                        mx-[0.5rem]
          ...
          >
            ...
            <div className='flex w-full mt-[1.5rem]'>
              <div className='w-1/2 pr-2'>
                <div className='font-semibold text-lg'>
                  금액 
                  <span className='ms-[0.5rem] text-sm'>(원{props.product.productType === 'RENT' && <span>/일</span>})</span>
                </div>
