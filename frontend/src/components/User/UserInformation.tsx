      ...
      <div className="bg-white p-6 w-full max-w-lg md:max-w-3xl lg:w-[44rem]">
        ...
        <div className="flex justify-center mb-10">
          <div className="relative w-28 h-28 rounded-full mx-auto border-[0.1rem]">
            ...
            <div className='opacity-0 hover:opacity-100 duration-200 absolute w-full h-full rounded-full mx-auto bg-[#00000098] text-white'>
        ...
        <div className="mb-6">
          ...
          <input type="text" className="w-full px-4 py-2 border-b focus:outline-none border-[#cccccc] placeholder-slate-400 focus:ring-0" placeholder='자기소개를 입력해주세요.'></input>
        </div>
